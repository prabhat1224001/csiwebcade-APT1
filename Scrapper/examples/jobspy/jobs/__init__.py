...
class CompensationInterval(Enum):
    ...
    def get_interval(cls, pay_period: str) -> Optional[str]:
        """Get the compensation interval value based on the pay period string."""
        pay_period = pay_period.strip().lower()
        for interval in cls:
            if interval.value == pay_period:
...
class JobPost(BaseModel):
    ...
    apply_link: Optional[str] = None  # Add this line
