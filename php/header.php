<img src="assets/img/logo.png" alt="Logo" style="height: 80px; position: relative; top: 10px; left: 20px;">
     ...
     <div class="container-fluid d-flex align-items-center justify-content-between">
         ...
         <nav id="navbar" class="navbar">
             <ul>
                 ...
                 <li><a class="nav-link scrollto" href="http://127.0.0.1:5000">Job Finder</a></li>
                 <li><a class="nav-link scrollto" href="http://localhost/Alu">Alumni</a></li>
             </ul>
